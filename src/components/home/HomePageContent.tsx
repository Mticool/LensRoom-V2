          ...
          <div className="relative overflow-hidden rounded-3xl border border-zinc-800 bg-zinc-900/50 backdrop-blur-sm p-8 md:p-10">
            ...
            <div className="relative">
              ...
              <div className="flex flex-wrap items-center gap-3 mb-4">
                <span className="text-amber-400 text-sm font-medium uppercase tracking-wider">Новинки</span>
                <div className="flex flex-wrap gap-2">
                  <span className="px-2.5 py-1 text-xs font-medium rounded-full bg-amber-500/10 text-amber-400 border border-amber-500/20">NanoBanana Pro бесплатно</span>
