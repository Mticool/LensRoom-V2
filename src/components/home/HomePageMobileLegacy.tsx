...
const ReferralInvite = dynamic(() => import('@/components/home/referral-invite').then((m) => ({ default: m.ReferralInvite })), { ssr: false });
...
export default function HomePageContent() {
  ...
  // Отложенная загрузка hero-видео — не конкурирует с JS/CSS при первой отрисовке
  useEffect(() => {
    const t = setTimeout(() => setHeroVideoReady(true), 1500);
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-[#0a0a0b] text-white overflow-x-hidden">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <motion.div 
            ...
            className="absolute top-[20%] left-[10%] w-[500px] h-[500px] bg-[#8cf425]/10 rounded-full blur-[150px]" 
          />
          <motion.div 
            animate={{ 
              x: [0, -40, 0],
            ...
            className="absolute bottom-[10%] right-[10%] w-[400px] h-[400px] bg-[#8cf425]/8 rounded-full blur-[120px]" 
          />
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          >
            <Image src="/showcase/1.jpg" alt="" width={144} height={192} className="w-full h-full object-cover" priority />
          </motion.div>
          ...
          >
            <Image src="/showcase/4.jpg" alt="" width={112} height={112} className="w-full h-full object-cover" />
          </motion.div>
          ...
          >
            {heroVideoReady ? (
              ...
              <Image src="/showcase/2.jpg" alt="" width={160} height={90} className="w-full h-full object-cover" />
            )}
          ...
          >
            <Image src="/showcase/5.jpg" alt="" width={128} height={160} className="w-full h-full object-cover" />
          </motion.div>
          ...
          >
            <Image src="/showcase/6.jpg" alt="" width={112} height={112} className="w-full h-full object-cover" />
          </motion.div>
          ...
          >
            <Image src="/showcase/2.jpg" alt="" width={128} height={170} className="w-full h-full object-cover" />
          </motion.div>
        </div>
        ...
        >
          ...
          >
            <span className="relative flex h-2.5 w-2.5">
              <span className="animate-ping absolute h-full w-full rounded-full bg-[#8cf425] opacity-75"></span>
              <span className="relative rounded-full h-2.5 w-2.5 bg-[#8cf425]"></span>
            </span>
          ...
          >
            ...
            <span className="flex items-center gap-2">
              <Video className="w-4 h-4 text-[#8cf425]" />
              Видео со звуком
            </span>
            <span className="flex items-center gap-2">
          ...
          >
            <Link href="/create/studio?section=photo">
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="group relative px-10 py-5 rounded-2xl bg-[#8cf425] text-black font-bold text-lg overflow-hidden shadow-[0_0_60px_rgba(205,255,0,0.3)]"
              >
      ...
      <section className="py-12 px-6">
        ...
        >
          <div className="relative overflow-hidden rounded-3xl border border-zinc-800 bg-zinc-900/50 backdrop-blur-sm p-8 md:p-10">
            {/* Subtle gradient */}
            <div className="absolute inset-0 bg-gradient-to-br from-lime-500/5 via-transparent to-violet-500/5" />
            
            <div className="relative">
              {/* Eyebrow + Pills */}
              <div className="flex flex-wrap items-center gap-3 mb-4">
                <span className="text-lime-400 text-sm font-medium uppercase tracking-wider">Новинки</span>
                <div className="flex flex-wrap gap-2">
                  <span className="px-2.5 py-1 text-xs font-medium rounded-full bg-lime-500/10 text-lime-400 border border-lime-500/20">NanoBanana Pro бесплатно</span>
              ...
              <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">
                NanoBanana Pro бесплатно на PRO/MAX
              </h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-6">
                <div className="flex items-start gap-3 p-3 rounded-xl bg-zinc-800/50">
                  ...
                  <div>
                    <p className="text-sm font-medium text-white">NanoBanana Pro бесплатно на PRO/MAX</p>
                    <p className="text-xs text-zinc-400">PRO: 2K бесплатно* • MAX: 4K бесплатно*</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 p-3 rounded-xl bg-zinc-800/50">
                  <Zap className="w-5 h-5 text-violet-400 shrink-0 mt-0.5" />
                  <div>
                    <p className="text-sm font-medium text-white">Motion Control доступен</p>
                    <p className="text-xs text-zinc-400">Во всех 3 тарифах</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 p-3 rounded-xl bg-zinc-800/50">
                  <Star className="w-5 h-5 text-emerald-400 shrink-0 mt-0.5" />
                  <div>
                    <p className="text-sm font-medium text-white">Еженедельные обновления</p>
                    <p className="text-xs text-zinc-400">Новые модели и режимы каждую неделю</p>
                  </div>
                </div>
              </div>
              ...
              {/* CTAs */}
              <div className="flex">
                <Link href="/create/studio" className="w-full sm:w-auto">
                  <motion.button
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-lime-500 text-black font-semibold text-sm"
                  >
                    Открыть генератор →
                  </motion.button>
                </Link>
              ...
              <p className="mt-4 text-xs text-zinc-500">
                Бесплатно* = без списания ⭐ в рамках разумного использования.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              Создано с <span className="text-[#8cf425]">LensRoom</span>
            </h2>
                  ...
                  >
                    ...
                    <div className="absolute bottom-4 left-4 right-4">
                      <div className="flex items-center justify-between">
                        ...
                        {work.hot && (
                          <span className="px-2 py-1 rounded-full bg-[#8cf425] text-black text-xs font-bold">
                            HOT
                          </span>
                        )}
                        {work.duration && (
                    ...
                    >
                      <div className="px-6 py-3 rounded-2xl bg-[#8cf425] text-black font-bold flex items-center gap-2 shadow-2xl">
      ...
      <section className="py-24 px-6 relative overflow-hidden">
        {/* Background */}
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-[#8cf425]/5 to-transparent" />
                ...
                <Link href={`/create/studio?section=photo&model=nano-banana-pro&prompt=${encodeURIComponent(style.prompt)}`}>
                  ...
                  >
                    ...
                    <div className="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity">
                      <ArrowRight className="w-4 h-4 text-[#8cf425]" />
                    </div>
                  </motion.div>
                </Link>
              </motion.div>
      ...
      <section className="py-32 px-6 relative overflow-hidden">
        {/* Background */}
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-gradient-to-t from-[#8cf425]/10 via-transparent to-transparent" />
          <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-[#8cf425]/20 rounded-full blur-[150px]" />
        </div>
        ...
        >
          ...
          <Link href="/create/studio?section=photo">
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="group relative px-12 py-6 rounded-2xl bg-[#8cf425] text-black font-bold text-xl overflow-hidden shadow-[0_0_80px_rgba(205,255,0,0.4)]"
            >
              <span className="relative z-10 flex items-center gap-3">
                Начать бесплатно
