      ...
      <div className="px-3 sm:px-4 py-3 sm:py-4">
        ...
        <div className="sm:hidden flex items-end gap-3">
          ...
          <button
            ...
            disabled={!canSubmit}
            title={!canSubmit ? "Fill required fields" : `Generate for ${estimatedCost} stars`}
            className={`
            ...
            >
              {isGenerating ? (
                ...
                <>
                  ...
                  <span>{isAuthenticated ? `Generate ${estimatedCost}⭐` : "Войти"}</span>
                </>
              )}
            </button>
          </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-[#18181B] border-t border-[#27272A] rounded-t-3xl max-h-[85vh] overflow-y-auto">
          ...
          <div className="p-4 space-y-5">
            ...
            <div className="space-y-2">
              <div className="text-xs text-[#A1A1AA] uppercase tracking-wider">Model</div>
            ...
            {!isToolModel && (
              <div className="space-y-2">
                <div className="text-xs text-[#A1A1AA] uppercase tracking-wider">Ratio</div>
            ...
            {qualityOptions && qualityOptions.length > 0 && (
              <div className="space-y-2">
                <div className="text-xs text-[#A1A1AA] uppercase tracking-wider">Quality</div>
                <div className="flex gap-2 flex-wrap">
            ...
            {onOutputFormatChange && outputFormatOptions.length > 0 && (
              <div className="space-y-2">
                <div className="text-xs text-[#A1A1AA] uppercase tracking-wider">Format</div>
            ...
            {!isToolModel && (
              <div className="space-y-2">
                <div className="text-xs text-[#A1A1AA] uppercase tracking-wider">Quantity</div>
            ...
            {supportsI2i && (
              <div className="space-y-3">
                <div className="text-xs text-[#A1A1AA] uppercase tracking-wider">
                  {isToolModel ? 'Image' : 'Reference Image'}
                </div>
                <div className="flex items-center gap-3">
                  <input
                    type="file"
            ...
            {onNegativePromptChange && (
              <div className="space-y-3 pt-4 border-t border-[#27272A]">
                <div className="text-xs text-[#A1A1AA] uppercase tracking-wider">Advanced</div>
                <div className="space-y-3">
                  <div>
                    <label className="text-sm text-[#A1A1AA] mb-1 block">Negative prompt</label>
                    <textarea
            ...
            <div className="pt-4 border-t border-[#27272A]">
              <div className="flex items-center justify-between">
                <div className="text-sm text-[#A1A1AA]">Cost</div>
