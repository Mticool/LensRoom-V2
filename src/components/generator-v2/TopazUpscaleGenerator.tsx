  ...
  const demoImages: GenerationResult[] = !isAuthenticated && images.length === 0 && history.length === 0 ? [
    {
      ...
      mode: 'image',
      settings: { model: 'topaz-image-upscale', size: '16:9', quality: 'balanced' },
      timestamp: Date.now(),
    },
    {
      id: 'demo-2',
      ...
      mode: 'image',
      settings: { model: 'topaz-image-upscale', size: '1:1', quality: 'balanced' },
      timestamp: Date.now(),
    },
    {
      id: 'demo-3',
      ...
      mode: 'image',
      settings: { model: 'topaz-image-upscale', size: '9:16', quality: 'balanced' },
      timestamp: Date.now(),
    },
    {
      id: 'demo-4',
      ...
      mode: 'image',
      settings: { model: 'topaz-image-upscale', size: '4:3', quality: 'balanced' },
      timestamp: Date.now(),
    },
  ] : [];
