      ...
      <div className="max-w-4xl mx-auto flex items-center gap-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <select
            ...
            disabled={disabled}
            className="px-3 py-1.5 bg-[#27272A] border border-[#3F3F46] rounded-md text-white text-sm focus:outline-none focus:ring-2 focus:ring-[#CDFF00] focus:border-transparent disabled:opacity-50 disabled:cursor-not-allowed"
          >
