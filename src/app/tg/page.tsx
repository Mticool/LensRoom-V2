...
const MODELS = {
  photo: [
    ...
    { id: 'gpt-image', name: 'GPT Image 1.5', cost: 17, icon: '🧠', badge: 'OpenAI' },
    { id: 'grok-imagine', name: 'Grok Imagine', cost: 15, icon: '🌶️', badge: 'xAI' },
    { id: 'seedream-4.5', name: 'Seedream 4.5', cost: 11, icon: '✨', badge: '4K' },
  ],
  video: [
    { id: 'veo-3.1', name: 'Veo 3.1', cost: 99, icon: '🎬', badge: 'Google' },
    { id: 'kling', name: 'Kling AI', cost: 105, icon: '⚡', badge: 'Trending' },
    { id: 'sora-2', name: 'Sora 2', cost: 50, icon: '🎥', badge: 'OpenAI' },
    { id: 'grok-video', name: 'Grok Video', cost: 25, icon: '🌶️', badge: 'xAI' },
  ],
  audio: [
