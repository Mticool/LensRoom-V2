      ...
      >
        ...
        >
          <div className="relative max-w-xl">
            <Search className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[rgba(255,255,255,0.40)]" />
            <Input
        ...
        {/* Results count */}
        <div className="mb-6 text-sm text-[rgba(255,255,255,0.55)]">
          ...
          >
            ...
            >
              ...
              >
                ...
                <div className="relative aspect-square overflow-hidden bg-[rgba(255,255,255,0.02)]">
                  ...
                  {prompt.isPremium && (
                    <div className="absolute top-3 right-3">
                      <Badge className="bg-gradient-to-r from-[var(--color-gold)] to-[var(--color-gold-light)] text-[#0a0a0f] font-bold px-3 py-1">
                  ...
                  <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                    <span className="text-white font-semibold bg-[rgba(255,255,255,0.1)] px-4 py-2 rounded-lg backdrop-blur-sm">
                      Открыть
                    </span>
                  </div>
                </div>
                ...
                {/* Content */}
                <div className="p-5 bg-gradient-to-b from-[rgba(255,255,255,0.04)] to-[rgba(255,255,255,0.02)]">
                  <h3 className="text-base font-bold text-white mb-2 line-clamp-1 group-hover:text-[var(--color-gold)] transition-colors">
                    {prompt.title}
                  </h3>
                  <p className="text-sm text-[rgba(255,255,255,0.60)] mb-4 line-clamp-2 leading-relaxed">
                    {prompt.description}
                  </p>
                  ...
                  <div className="flex flex-wrap gap-1.5 mb-4">
                    {prompt.tags.slice(0, 3).map((tag) => (
                      <span
                        key={tag}
                        className="px-2 py-0.5 rounded-full bg-[rgba(255,255,255,0.06)] text-xs text-[rgba(255,255,255,0.60)] border border-[rgba(255,255,255,0.06)]"
                      >
                        #{tag}
                      </span>
                    ))}
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-[rgba(255,255,255,0.06)]">
                    <div className="flex items-center gap-3 text-sm text-[rgba(255,255,255,0.50)]">
        ...
        {!isLoading && filteredPrompts.length === 0 && (
          <div className="text-center py-20">
            <p className="text-[rgba(255,255,255,0.70)] text-lg">
              Промпты не найдены
            </p>
            <p className="text-[rgba(255,255,255,0.55)] mt-2">
