        ...
        <main className="flex-1 p-6">
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
              ...
              {/* Preview Skeleton */}
              <div className="aspect-square bg-[var(--surface)] rounded-xl flex items-center justify-center">
                <div className="text-center">
                  <Sparkles className="w-12 h-12 text-[var(--gold)] mx-auto mb-4 animate-pulse" />
                  <Loader2 className="w-8 h-8 text-[var(--gold)] animate-spin mx-auto" />
                  <p className="text-sm text-[var(--muted)] mt-4">Загрузка генератора...</p>
                </div>
              </div>
            </div>
          </div>
