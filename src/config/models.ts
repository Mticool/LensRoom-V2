...
export const PHOTO_MODELS: PhotoModelConfig[] = [
  ...
  },
  {
    ...
    type: 'photo',
    provider: 'kie_market',
    description: 'FLUX.2 Pro — топ по фактурам/материалам (предметка, упаковка, ткань, металл). Выбор 1K/2K.',
    rank: 7,
    featured: true,
    speed: 'medium',
    quality: 'ultra',
  ...
  },
  {
    ...
    type: 'photo',
    provider: 'kie_market',
    description: 'Topaz Upscale — выбор ≤2K / 4K / 8K (требует входное изображение).',
    rank: 23,
    featured: false,
    speed: 'medium',
    quality: 'ultra',
